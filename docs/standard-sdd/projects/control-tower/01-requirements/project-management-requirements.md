...
- Visual reference: no dedicated Project Management HTML mockup exists in `docs/standard-sdd/projects/control-tower/05-design/` as of 2026-04-17; the MilestoneExecutionHub pattern in [Project Space.html](../05-design/Project%20Space.html) and the general Tactical Command aesthetic in [design.md](../05-design/design.md) are the reuse anchors.
