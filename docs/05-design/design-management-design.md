...
- Phase A Viewer renders the actual HTML files in `docs/05-design/*.html` as preview content by mapping seed artifact IDs to file paths. This gives the UI a realistic first impression before the backend lands.
